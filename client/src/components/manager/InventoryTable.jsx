            ...
            {items.map((item) => {
              ...
              return (
                <tr key={item.id} className="border-b border-[#f0ede6] hover:bg-[#faf9f6] transition-colors">
                  <td className="p-3 font-semibold text-[#08060d]">
                  ...
                  <td className="p-3">
                    <div className="flex items-center gap-2">
                      <button
                        ...
                        className="w-7 h-7 rounded-lg border border-[#e5e4e7] flex items-center justify-center hover:bg-[#f0ede6] transition-colors"
                      >
                        <Minus size={14} />
                      </button>
                      ...
                      <button
                        onClick={() => onRestock?.(item.id, 1)}
                        className="w-7 h-7 rounded-lg border border-[#1D9E75] bg-[#1D9E75] text-white flex items-center justify-center hover:opacity-80 transition-opacity"
                      >
                        <Plus size={14} />
                      </button>
                    </div>
                  ...
                  <td className="p-3">
                    <button
                      ...
                      className="text-[#A32D2D] hover:bg-[#FCEBEB] p-1.5 rounded-lg transition-colors"
                    >
                      <Trash2 size={16} />
                    </button>
                  </td>
