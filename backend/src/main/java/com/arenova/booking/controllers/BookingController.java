package com.arenova.booking.controllers;
...
import com.arenova.booking.services.BookingService;
...
public class BookingController {
    ...
    public ResponseEntity<ApiResponse> cancelBooking(@PathVariable Long id) {
        ...
        return ResponseEntity.ok(new ApiResponse("Booking cancelled successfully and slot/equipment released", "Success"));
    }
